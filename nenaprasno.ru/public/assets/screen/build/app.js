	    ...
	    methods: {
	        ...
	        init: function init() {
	            ...
	            this.auth().then(function () {
	                ...
	                _this3.$store.commit('hideSpinner');
	            }).catch(function (e) {
	                if (e.response && e.response.status === 401) {
	                    ...
	                    _this3.$store.commit('setAppError', {
	                        status: true,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Spinner = __webpack_require__(155),
	    formBreadcrumbs = __webpack_require__(44),
	    ...
	    formAppError = __webpack_require__(235),
	    ...
	    methods: {
	        ...
	        submitForm: function submitForm() {
	            ...
	            if (pageValidation(this.part, this.$store)) {
	                ...
	                formSubmit(this).then(function (response) {
	                    alert(config.messages.successFormPost);
	
	                    // Scrolling to top of next page
	                    _this.$root.$el.scrollIntoView(true);
	                    ...
	                    _this.$store.commit('hideSpinner');
...
/***/ (function(module, exports) {
	...
	function findInStore(id, $store) {
	    return $store.state.form.data.find(function (v) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    computed: {
	        storeShowErrors: function storeShowErrors() {
	            var _this = this;
	
	            return this.$store.state.form.data.find(function (ctrl) {
	    ...
	    methods: {
	        fetchControl: function fetchControl() {
	            ...
	            var ctrl = this.$store.state.form.data.find(function (ctrl) {
	                return ctrl.controlId === _this2.control.id;
	            });
	    ...
	    watch: {
	        ...
	        storeShowErrors: function storeShowErrors(val) {
	            this.showErrors = val;
	        }
	    },
	    mounted: function mounted() {
...
/***/ (function(module, exports) {
	...
	function $value(controlId, component) {
	    return component.$store.state.form.data.find(function (v) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getUserProfile($store) {
	    return new Promise(function (resolve, reject) {
	        var userId = $store.state.user.userId || $store.state.user.id,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [(_vm.showProfileModal) ? _c('form-profile-modal') : _vm._e()], 1), _vm._v(" "), _c('transition', {
	    attrs: {
	      "name": "fade"
	    }
	  }, [(_vm.spinner) ? _c('div', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Vuex = __webpack_require__(5),
	    userAPI = __webpack_require__(125),
	    formAPI = __webpack_require__(56),
	    objectAPI = __webpack_require__(152);
	...
	module.exports = new Vuex.Store({
	    ...
	    mutations: {
	        ...
	        addControl: function addControl(state, control) {
	            var foundControls = state.form.data.find(function (v) {
	        ...
	        addResultControl: function addResultControl(state, control) {
	            var foundControls = state.form.resultData.find(function (v) {
	                return v.controlId === control.controlId;
	            });
	        ...
	        showSpinner: function showSpinner(state) {
	            state.spinner = true;
	        },
	        hideSpinner: function hideSpinner(state) {
	            state.spinner = false;
	        },
	        setAppError: function setAppError(state, payload) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
	  ...
	  return function (modules) {
	    ...
	    module.exports = function normalizeComponent(rawScriptExports, compiledTemplate, scopeId, cssModules) {
	      ...
	      if (cssModules) {
	        var computed = (0, _create2.default)(options.computed || null);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(181)(IteratorPrototype, __webpack_require__(213)('iterator'), function () {
	  return this;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uid = __webpack_require__(174);
	var _Symbol = __webpack_require__(173).Symbol;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hide = __webpack_require__(181);
	var Iterators = __webpack_require__(210);
	var TO_STRING_TAG = __webpack_require__(213)('toStringTag');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.f = __webpack_require__(213);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(173);
	var has = __webpack_require__(163);
	var DESCRIPTORS = __webpack_require__(186);
	var $export = __webpack_require__(177);
	var redefine = __webpack_require__(209);
	...
	var setToStringTag = __webpack_require__(212);
	var uid = __webpack_require__(174);
	var wks = __webpack_require__(213);
	var wksExt = __webpack_require__(219);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/alexey/PhpstormProjects/nenaprasno/nenaprasno.ru/public/assets/screen/app/components/form-app-error.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] form-app-error.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-35b4682e", Component.options)
	  } else {
	    hotAPI.reload("data-v-35b4682e", Component.options)
	  }
	})()}
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  computed: {
	    display: function display() {
	      return this.$store.state.appError.status;
	    },
	    message: function message() {
	      return this.$store.state.appError.message;
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return (_vm.display) ? _c('div', {
	    staticClass: "form-app-error"
	  }, [_c('div', {
	    staticClass: "form-app-error-message"
	  }, [_c('a', {
	    attrs: {
	      "href": "#"
	    },
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-35b4682e", module.exports)
	  }
	}
