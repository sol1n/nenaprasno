...
<main class="main-content">
    <section class="header-slider-wrapper">
        <div class="header-slider js-header-slider">
            <div class="header-slider-item header-slider-item-screen" style="background-image: url('../../assets/images/slider/screen2.0/blue-bg.svg');">
                <img class="animated fadeIn" src="../../assets/images/slider/screen2.0/logo.svg" alt="Screen 2.0">
            </div>
            <div class="header-slider-item header-slider-item-vsho" style="background-image: url('../../assets/images/slider/vsho/orange-bg.svg');">
                <img class="animated fadeIn" src="../../assets/images/slider/vsho/logo.svg" alt="Высшая школа онкологии Ненапрасно">
            </div>
        </div>

        <a href="#" class="header-slider-prev js-header-slider-prev">
            <?php include "../../assets/images/slider-arrow-left.svg"; ?>
        </a>
        <a href="#" class="header-slider-next js-header-slider-next">
            <?php include "../../assets/images/slider-arrow-right.svg"; ?>
        </a>
            ...
            <div class="about-fund-blocks">
                <div class="about-fund-blocks-col">
                    <a href="#" class="about-fund-block b-green">
                        <div class="about-fund-block-icon">
                            <?php include "../../assets/images/icon-about-fund-1.svg"; ?>
                        </div>
                        ...
                        <div href="#" class="about-fund-block-arrow">
                            <?php include "../../assets/images/about-fund-arrow.svg"; ?>
                        </div>
                    </a>
                </div>
                <div class="about-fund-blocks-col">
                    <a href="#" class="about-fund-block b-blue">
                        <div class="about-fund-block-icon">
                            <?php include "../../assets/images/icon-about-fund-2.svg"; ?>
                        </div>
                        <div class="about-fund-block-text">
                            Как можно помочь
                            деятельности Фонда?
                ...
                <div class="about-fund-blocks-col">
                    <a class="about-fund-block b-orange">
                        <div class="about-fund-block-icon">
                            <?php include "../../assets/images/icon-about-fund-3.svg"; ?>
                        </div>
                        <div class="about-fund-block-text">
                ...
                <div class="about-fund-blocks-col">
                    <a class="about-fund-block b-red">
                        <div class="about-fund-block-icon">
                            <?php include "../../assets/images/icon-about-fund-4.svg"; ?>
                        </div>
                        <div class="about-fund-block-text">
        ...
        <div class="wrapper">
            ...
            <div class="news-block-items">
                <div class="news-block-items-col">
                    <a href="#" class="news-block-item">
                        <div class="news-block-item-image">
                            <img src="../../assets/images/tmp/news-1.jpg" alt="">
                        </div>
                ...
                <div class="news-block-items-col">
                    <a href="#" class="news-block-item">
                        <div class="news-block-item-image">
                            <img src="../../assets/images/tmp/news-2.jpg" alt="">
                        </div>
                        <div class="news-block-item-content">
                            <div class="news-block-item-date">27 июля</div>
                ...
                <div class="news-block-items-col">
                    <a href="#" class="news-block-item">
                        <div class="news-block-item-image">
                            <img src="../../assets/images/tmp/news-3.jpg" alt="">
                        </div>
                        <div class="news-block-item-content">
                            <div class="news-block-item-date">27 июля</div>
                ...
                <div class="news-block-items-col">
                    <a href="#" class="news-block-item">
                        <div class="news-block-item-image">
                            <img src="../../assets/images/tmp/news-4.jpg" alt="">
                        </div>
                        <div class="news-block-item-content">
                            <div class="news-block-item-date">27 июля</div>
            ...
            <div class="cancer-directory-block-header">
                ...
                <form action="#" method="GET" class="cancer-directory-block-search">
                    ...
                    <button class="cancer-directory-block-search-button" type="submit">
                        <?php include "../../assets/images/icon-magnifying-glass.svg"; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="how-test-works-block-items">
                <div class="how-test-works-block-item">
                    <div class="how-test-works-block-item-icon">
                        <?php include "../../assets/images/icon-how-test-works-test.svg"; ?>
                    </div>
                ...
                <div class="how-test-works-block-item">
                    <div class="how-test-works-block-item-icon">
                        <?php include "../../assets/images/icon-how-test-works-calendar.svg"; ?>
                    </div>
                    <div class="how-test-works-block-item-text">
                ...
                <div class="how-test-works-block-item">
                    <div class="how-test-works-block-item-icon">
                        <?php include "../../assets/images/icon-how-test-works-clinic.svg"; ?>
                    </div>
                    <div class="how-test-works-block-item-text">
                ...
                <div class="how-test-works-block-item">
                    <div class="how-test-works-block-item-icon">
                        <?php include "../../assets/images/icon-how-test-works-email.svg"; ?>
                    </div>
                    <div class="how-test-works-block-item-text">
                        Получайте регулярные
                ...
                <div class="logotypes-block-slider-items js-logotypes-slider">
                    <div class="logotypes-block-slider-item">
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/takie-dela.png" alt="Такие дела">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/village.png" alt="The Village">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/dozhd.png" alt="Дождь LIVE">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/lenta.png" alt="Lenta.ru">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/question.png" alt="The Question">
                        </a>
                    </div>
                    <div class="logotypes-block-slider-item">
                        <a href="#" class="logotypes-block-slider-image">
        ...
        <div class="wrapper">
            ...
            <div class="logotypes-block-slider">
                <div class="logotypes-block-slider-items js-logotypes-slider">
                    <div class="logotypes-block-slider-item">
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/metro.png" alt="Metro">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/zdorovye.png" alt="Здоровье">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/doctor-piter.png" alt="Доктор Питер">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/fontanka.png" alt="Фонтанка.ру">
                        </a>
                        <a href="#" class="logotypes-block-slider-image">
                            <img src="../../assets/images/tmp/spbvedomosti.png" alt="СПБ Ведомости">
                        </a>
                    </div>
