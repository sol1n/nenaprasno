        ...
        <div class="main-wrapper">
            ...
            <div class="main-wrapper-column">
                <div class="article-page">
                    <img src="../../assets/images/tmp/text-article.jpg" class="img-responsive" alt="">
                    ...
                    <p>
                        <img src="../../assets/images/tmp/text-article-2.jpg" alt="" class="img-responsive">
                    </p>
                    ...
                    <div class="row">
                        <?php for ($i = 0; $i < 8; $i++) : ?>
                            <div class="col-xs-6 col-md-3">
                                <a href="../../assets/images/tmp/text-article-2.jpg" data-fancybox="gallery-1">
                    ...
                    <div class="quotation-block">
                        <div class="quotation-block-author">
                            <div class="quotation-block-author-photo">
                                <img class="img-responsive" src="../../assets/images/tmp/staff-2.jpg" alt="Илья Фоминцев">
                            </div>
