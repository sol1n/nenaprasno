            ...
            <aside class="main-sidebar main-sidebar-left">
                    <nav class="main-sidebar-menu">
                        <ul>
                            ...
                            <li class="active"><a href="#">Сотрудники Фонда</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-4">
                            <div class="staff-block-item">
                                <div class="staff-block-item-photo">
                                    <a href="#">
                                        <img class="img-responsive" src="../../assets/images/tmp/staff-1.jpg" alt="Барчук Алексей Степанович">
                                    </a>
                                </div>
                                ...
                                <div class="staff-block-item-desc">
                                    ...
                                    Д.М.Н., профессор, торакальный хирург
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="staff-block-item">
                                <div class="staff-block-item-photo">
                                    <a href="#">
                                        <img class="img-responsive" src="../../assets/images/tmp/staff-2.jpg" alt="Фоминцев Илья Алексеевич">
                                    </a>
                                </div>
                                <div class="staff-block-item-name">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="staff-block-item">
                                <div class="staff-block-item-photo">
                                    <a href="#">
                                        <img class="img-responsive" src="../../assets/images/tmp/staff-3.jpg" alt="Борунов Александр Васильевич">
                                    </a>
                                </div>
                                <div class="staff-block-item-name">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="staff-block-item">
                                <div class="staff-block-item-photo">
                                    <a href="#">
                                        <img class="img-responsive" src="../../assets/images/tmp/staff-4.jpg" alt="Коваль Елена Александровна">
                                    </a>
                                </div>
                                <div class="staff-block-item-name">
